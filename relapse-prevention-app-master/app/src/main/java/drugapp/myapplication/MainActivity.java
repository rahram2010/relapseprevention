...
public class MainActivity extends AppCompatActivity {
    ...
    public Button locbut;
    public Button textbut;
    public Button abobut;
    ...
    public void init(){
        ...
        textbut = (Button)findViewById(R.id.textbut);
        textbut.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                new Thread(new HttpPostRequest()).start();
                Snackbar.make(v, "Text sent", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();
            }
        });

        abobut = (Button)findViewById(R.id.abobut);
        abobut.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent intend = new Intent(MainActivity.this, About.class);
